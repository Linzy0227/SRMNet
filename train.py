...
def main():
    ...
    if args.dataname in ['BRATS2020', 'BRATS2015']:
        ...
        ####BRATS2018 contains three splits (1,2,3) 先训练train3
    ...
    for epoch in range(args.start_epoch, args.num_epochs):
        ...
        for i in range(iter_per_epoch):
            ...
            sr_loss = criterions.l1loss(flair, srs[0]) + criterions.l1loss(t1ce, srs[1]) + criterions.l1loss(t1, srs[2]) + criterions.l1loss(t2, srs[3])

            loss = pred_loss + preds_loss + 0.1*sr_loss
            ...
            writer.add_scalar('sr_loss', sr_loss.item(), global_step=step)
            ...
            msg += 'l1loss:{:.4f},'.format(sr_loss.item())
            logging.info(msg)
